...
{
    public partial class AjoutTestCtor : Form
    {
        public Constructeur Ctor { get; set; }
        public Test Test { get; set; }
        public Test_Constructeur Tctor { get; set; }

        public AjoutTestCtor(Constructeur ctor)
        {
            Ctor = ctor;
        ...
        private void ModifierTestCtor_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Close();
            //AjouterTestCtorTeinte ATCT = new AjouterTestCtorTeinte(Ctor);
            //ATCT.ShowDialog();
        }
    }
}
