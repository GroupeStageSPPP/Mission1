...
namespace QualiteSPPP.Travail
{
    public partial class AjouterPeinture : Form
    {
        ...
        private void buttonAjouterADMINISTRATIONPeinture_Click(object sender, EventArgs e)
        {
            ...
            T.Min = Double.Parse(this.TBmin.Text);
            T.Norme = Double.Parse(this.TBnorme.Text);
            T.Max = Double.Parse(this.TBmax.Text);
        ...
        private void AjouterPeinture_Load(object sender, EventArgs e)
        {
